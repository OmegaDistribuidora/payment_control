...
public class ReferenceController {
    ...
    @PostMapping("/despesas/config")
    public ReferenceBundle salvarDespesaConfig(@RequestBody @Valid DespesaConfigRequest request) {
        return service.salvarDespesaConfig(request);
    }
}
